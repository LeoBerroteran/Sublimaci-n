  ...
  return (
    <AdminLayout activeSection={activeSection} onNavigate={setActiveSection}>
      {activeSection === 'dashboard' && (
        <div>
          <h2 style={{ fontSize: 'clamp(1.5rem, 4vw, 1.8rem)', marginBottom: '20px', color: 'var(--dark)' }}>
          ...
          <div className="admin-card" style={{ backgroundColor: 'var(--white)', padding: '24px', borderRadius: 'var(--radius)', boxShadow: '0 2px 12px var(--shadow)' }}>
            <h3 style={{ marginBottom: '12px', color: 'var(--dark)', fontSize: '1.2rem' }}>Bienvenido al Panel de Control</h3>
